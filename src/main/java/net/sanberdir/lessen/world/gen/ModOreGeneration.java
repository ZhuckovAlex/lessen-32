...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInSpecificBiome(YellowForest.YELLOW_FOREST, OreType.IRON_ORE, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.BIRCH_FOREST, OreType.IRON_ORE, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Desert.DESERT, OreType.GOLD_ORE, event, Dimension.OVERWORLD.toString());
        spawnOreInOverworldInAllBiomes(OreType.EMERALD_ORE_OVERWORLD, event);
        spawnOreInAllBiomes(OreType.PRISMARINE_ENDER, event, Dimension.THE_END.toString());
    }
    ...
    private static void spawnOreInAllBiomesCustomDim(OreType currentOreType, final BiomeLoadingEvent event, String world) {
        event.getGeneration().withFeature(GenerationStage.Decoration.UNDERGROUND_ORES,
                makeOreFeature(currentOreType, world));
    }
