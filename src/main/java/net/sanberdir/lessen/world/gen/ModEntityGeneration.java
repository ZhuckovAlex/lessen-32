...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, ModEntityTypes.METAL_SPIDER.get(), 100, 1, 3,
                Biomes.DARK_FOREST);
        addEntityToAllBiomesNoNether(event, ModEntityTypes.METAL_SPIDER.get(), 100, 1, 2);
        addEntityToAllOverworldBiomes(event, EntityType.CAT, 100, 1, 2);
    }
