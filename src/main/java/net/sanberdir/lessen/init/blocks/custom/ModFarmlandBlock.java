...
public class ModFarmlandBlock extends Block {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? InitBlocks.PURPLE_DIRT.get().getDefaultState() : super.getStateForPlacement(context);
    }
    ...
    public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
        if (!worldIn.isRemote && net.minecraftforge.common.ForgeHooks.onFarmlandTrample(worldIn, pos, InitBlocks.PURPLE_DIRT.get().getDefaultState(), fallDistance, entityIn)) { // Forge: Move logic to Entity#canTrample
    ...
    public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
        worldIn.setBlockState(pos, nudgeEntitiesWithNewState(state, InitBlocks.PURPLE_DIRT.get().getDefaultState(), worldIn, pos));
    }
